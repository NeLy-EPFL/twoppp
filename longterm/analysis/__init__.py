...
class InterPCAAnalysis():
    ...
    def preprocess_neurons(self, zscore_trials="all"):
    ...
    def preprocess_pixels(self, zscore_trials="all"):
    ...
    def i_compare_in_i_trials(self):
        return [np.argwhere(np.array(self.i_trials) == selected)[0,0] for selected in self.compare_i_trials]
